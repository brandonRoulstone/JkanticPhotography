  ...
  return (
    <section id="ReviewsSection">
      <div id="newGrid" className="mt-3">
        ...
        <ReviewCards name="Ralph Tshibanda" reviews={3} photo="https://cdn-images.imagevenue.com/5b/8f/03/ME17Y7G3_o.jpg" review="One of the best photographers I've ever worked with!! Very highly recommended!!!!"/>
        <ReviewCards name="Daiyaan Abrahams" reviews={1} photo="https://cdn-images.imagevenue.com/77/f2/ff/ME17Y38K_o.jpg" review="One of the best Photographers in Cape Town! Jkantic knows what you want and makes sure that you get the best results and captures memorable photos or videos.I highly recommend Jkantic Photography for all special events and for special moments!"/>
      </div>
    </section>
  )
}
